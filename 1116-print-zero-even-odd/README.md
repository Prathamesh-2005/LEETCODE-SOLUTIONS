<h2><a href="https://leetcode.com/problems/print-zero-even-odd/?envType=problem-list-v2&envId=v2yn5er3">1116. Print Zero Even Odd</a></h2><h3>Medium</h3><hr><p>You have a function <code>printNumber</code> that can be called with an integer parameter and prints it to the console.</p>
